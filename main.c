...
int main(void) {
    ...
    GPIOA->CRH &= ~(GPIO_CRH_CNF11 | GPIO_CRH_MODE11); // RS
    GPIOA->CRH |= GPIO_CRH_MODE11_0; 

    GPIOA->CRH &= ~(GPIO_CRH_CNF12 | GPIO_CRH_MODE12); //RSE
    GPIOA->CRH |= GPIO_CRH_MODE12_0;

    GPIOA->CRL &= ~(GPIO_CRL_CNF5 | GPIO_CRL_MODE5); // GPIOA->CRL[23:20]=0000 //SCL
    GPIOA->CRL |= GPIO_CRL_MODE5_0; // GPIOA->CRL[23:20]=0001
    GPIOA->CRL |= GPIO_CRL_CNF5_1;

    GPIOA->CRL &= ~(GPIO_CRL_CNF7 | GPIO_CRL_MODE7); //SL
